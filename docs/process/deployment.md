...
```bash
scp -O -P 2222 website/index.html justin@192.168.1.234:/volume1/Websites/simplepitchcounter.com/
scp -O -P 2222 website/privacy.html justin@192.168.1.234:/volume1/Websites/simplepitchcounter.com/
scp -O -P 2222 website/contact.html justin@192.168.1.234:/volume1/Websites/simplepitchcounter.com/
```
...
- Verify SSH: `ssh -p 2222 justin@192.168.1.234`
